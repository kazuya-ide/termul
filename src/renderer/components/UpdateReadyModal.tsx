          ...
          >
            ...
            <div className="px-4 py-3 border-b border-border flex justify-between items-center bg-secondary/50">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-foreground">更新の準備ができました</h3>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-xs font-medium text-muted-foreground">バージョン</span>
                ...
                <div className="flex items-start gap-2 bg-amber-500/5 border border-amber-500/20 rounded px-3 py-2">
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-amber-600 dark:text-amber-400">
                      今すぐ再起動すると、実行中のターミナルセッションはすべて終了します。更新を適用する前に、
                      重要な作業内容を保存してください。
                    </p>
                  </div>
                </div>
